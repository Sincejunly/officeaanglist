...
read_setting(){
  ...
  if [[ -n "$REDIS_PASSWORD" ]]; then
    REDIS_SERVER_HOST="${REDIS_SERVER_HOST}:${REDIS_PASSWORD}"
  fi
...
'
  ...
  if [ -n "$AListdb_us" ] && [ -n "$AListdb_port" ] && [ -n "$AListdb_pw" ] && [ -n "$AListdb_ty" ] && [ -n "$AListdb_host" ] && [ -n "$AListdb_name" ]; then
    ...
    sed -i "11s/.*/    \"user\": \"$AListdb_us\",/" /var/www/app/AList/data/config.json
...
# echo "AriaNg-1.3.6"
# echo "AList-v3.18.0"
# echo "documentserver:7.1.1"
# echo "officeaanglist-v0.2"

echo -e "\033[34m  _                                          \033[0m";
echo -e "\033[34m | |                                         \033[0m";
echo -e "\033[34m | |__    ___   _ __ ___   _   _  _ __  __ _ \033[0m";
echo -e "\033[34m | '_ \  / _ \ | '_ \` _ \ | | | || '__|/ _\` |\033[0m";
echo -e "\033[34m | | | || (_) || | | | | || |_| || |  | (_| |\033[0m";
echo -e "\033[34m |_| |_| \___/ |_| |_| |_| \__,_||_|   \__,_|\033[0m";
echo -e "\033[34m                                             \033[0m";
echo -e "\033[34m                                             \033[0m";
